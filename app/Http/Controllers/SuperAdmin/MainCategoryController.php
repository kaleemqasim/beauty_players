...
class MainCategoryController extends SuperAdminBaseController
{
    ...
    public function index()
    {
            ...
            return \datatables()->of($categories)
                ->addColumn('action', function ($row) {
                    ...
                    if ($this->user->roles()->withoutGlobalScopes()->first()->hasPermission('update_category')) {
                        $action .= '<a href="' . route('superadmin.main-categories.edit', [$row->id]) . '" class="btn btn-primary btn-circle" data-toggle="tooltip" data-original-title="' . __('app.edit') . '"><i class="fa fa-pencil" aria-hidden="true"></i></a>';
                    }
        ...
        return view('superadmin.main-categories.index');
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.main-categories.create');
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('superadmin.main-categories.edit', $this->data);
    }
    ...
    public function update(StoreCategory $request, $id)
    {
        ...
        return Reply::redirect(route('superadmin.main-categories.index'), __('messages.updatedSuccessfully'));
    }

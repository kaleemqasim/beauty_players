...
<nav class="mt-4">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="sidebarnav">
        ...
        @if ($user->is_superadmin_employee)
            ...
            <li class="nav-item">
                <a href="{{ route('superadmin.main-categories.index') }}" class="nav-link {{ request()->is('super-admin/main-categories*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ $user->is_superadmin_employee ? route('superadmin.tickets.index') : route('admin.tickets.index') }}" class="nav-link {{ (request()->is('super-admin/ticket*') || request()->is('account/ticket*')) ? 'active' : '' }}">
